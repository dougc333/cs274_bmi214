...
print(find_align_location("pa1/student_files/quiz_input/quiz1.input", "output1_g"))
print(find_align_location("pa1/student_files/quiz_input/quiz1.input", "output1_local"))

print(count_gaps("output1_g"))
print(count_gaps("output1_local"))

print(count_mismatches("output1_g"))
print(count_mismatches("output1_local"))
